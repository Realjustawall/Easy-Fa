...
const platforms={
  kick:{name:'Kick',accent:'#53fc18'},youtube:{name:'YouTube Live',accent:'#ff0033'},twitch:{name:'Twitch',accent:'#9147ff'},
...
const fonts=[
remote('vazirmatn','Vazirmatn','EasyFa Vazirmatn','https://cdn.jsdelivr.net/gh/rastikerdar/vazirmatn@master/fonts/webfonts/','Vazirmatn-Regular.woff2','Vazirmatn-Bold.woff2'),
...
const base=p=>({enabled:true,direction:'smart',fontId:'vazirmatn',fontScope:'fa',sizeScope:'fa',fontSize:16,fontWeight:500,lineHeight:1.75,composer:false,accent:platforms[p]?.accent||'#22c55e'});
E.Config=Object.freeze({KEY:'easyFaV10',VERSION:10.1,ARABIC_RANGE:'U+0600-06FF,U+0750-077F,U+0870-089F,U+08A0-08FF,U+FB50-FDFF,U+FE70-FEFF',platforms,fonts,base,defaults:{version:10.1,active:'kick',profiles:Object.fromEntries(Object.keys(platforms).map(p=>[p,base(p)])),customSites:[]}});
})();
